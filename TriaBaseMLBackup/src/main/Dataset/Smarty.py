...
class Smarty:
    ...
    def get_dataset(self):
        smarty_train, smarty_test = tff.simulation.datasets.emnist.load_data(only_digits=True)
        ...
        smarty_train = smarty_train.preprocess(preprocess_train_dataset)
        smarty_test = preprocess_test_dataset(smarty_test.create_tf_dataset_from_all_clients())

        return smarty_train, smarty_test
