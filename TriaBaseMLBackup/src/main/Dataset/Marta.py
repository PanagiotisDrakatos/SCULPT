...
class Marta:
    ...
    def get_dataset(self):
        marta_train, marta_test = tff.simulation.datasets.emnist.load_data(only_digits=True)
        ...
        marta_train = marta_train.preprocess(preprocess_train_dataset)
        marta_test = preprocess_test_dataset(marta_test.create_tf_dataset_from_all_clients())

        return marta_train, marta_test
